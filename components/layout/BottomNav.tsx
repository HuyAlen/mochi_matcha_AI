...
import { Baby, Brain, Home, LineChart, Utensils } from "lucide-react";
...
const navItems = [
  ...
  },
  {
    ...
    label: "Thực đơn",
    icon: Utensils,
    activePaths: ["/nutrition"],
  },
  {
    href: "/ai-coach",
    label: "AI Coach",
    icon: Brain,
    activePaths: ["/ai-coach"],
  },
  {
    href: "/babies",
    label: "Hồ sơ",
    icon: Baby,
    activePaths: ["/babies", "/milestones", "/vaccines", "/vaccine"],
  },
];
            ...
            >
              <div
                className={`flex h-9 w-9 items-center justify-center rounded-2xl transition ${
                  active
                    ? "bg-gradient-to-br from-indigo-400 to-violet-400 text-white shadow-md shadow-indigo-100"
                    : "text-slate-400"
                }`}
              >
                <Icon size={19} />
